...
use LegitHealth\MedicalDevice\MedicalDeviceArguments\{DiagnosisSupportArguments, MedicalDeviceArguments, SeverityAssessmentArguments};
...
final class MedicalDeviceClient
{
    ...
    {
        $json = $this->send($arguments, self::SEVERITY_ASSESSMENT, $bearerToken);
    ...
    {
        $json = $this->send($arguments, self::DIAGNOSIS_SUPPORT_ENDPOINT, $bearerToken);
     ...
     * @throws RequestException
     */
    private function send(MedicalDeviceArguments $arguments, string $path, BearerToken $bearerToken): array
    {
        try {
